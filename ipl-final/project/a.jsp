...
<style>
    ...
    .b { color:red; font-family:sans-serif; }
...
clearTimeout(timer);
    ...
    <body onload="blinking_header()" onunload="stoptimer()">
      <center> <img src="113.jpg" height="200px" width="400px"></center>
...
{       String s1;
       ...
       while(rs.next())
       {
          ...
          s3=rs.getString("dat");
	   out.println("Hello");
          out.println("<div style='color:red'><br><p style='position:absolute; left:100'>"+s1+"</p><br><br></div>");
