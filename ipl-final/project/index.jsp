<html>
    <head>
        ...
        <style>
	button { background-color:white; width:120px; }
...
clearTimeout(timer);
	...
	<%@ include file="home.jsp" %>
        <% //out.println("<img src='111.jpg' height=200px width:300px>");%>
        ...
        <%try
{
      ...
      int i1=1;
       out.println("<br><br<center><span style='position:absolute; left:590; top:260; filter:glow(strength=3,color=red)'>FORUM TOPICS</span></center>");
        out.println("<span style='position:absolute;top:270;left:350'>");
       ...
       while(rs.next())
       {
          ...
          out.println("<td><input type='submit' name="+s2+" id="+s2+" value='View Topic' onClick='re(this.id)'><td></tr>");
