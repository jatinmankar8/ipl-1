...
<center>
		...
		<%@ include file="home.jsp" %></center><br><br>
           ...
           Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
            ...
            while(rs.next())
            {
             if(i==j)
                 ...
                 s=path1+s;
                 s=s+".txt";
                 out.println("<br><br><div style='position:absolute; left:200px; top:150px'><br><br><p style='color:green; font-size:16pt'>"+rs.getString("title")+"</p><br><br>");
