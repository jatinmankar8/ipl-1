<html>
    ...
    <style>
        ...
        .c { color:blue ;}
        .z { color:purple; font-size:small; font-family:Eras Demi ITC}
...
while(rs.next())
{
    if(i1==0)
        {
    p=rs.getInt("score");
	out.println("<h4 style='position:absolute; top:150; left:1030'>Current match Score:</h4>");
	out.println("<a href='news.jsp'><img src='cricket.gif' style='position:absolute; left:880; top:170'></a>");
	//out.println("<a href='news.jsp'><img src='score.gif' style='position:absolute; left:750; top:170'></a>");
	out.println("<br><br><span style='position:absolute; left:1000; top:160; width:500'>");
