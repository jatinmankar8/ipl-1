...
div.S2    { color:white;
	position: absolute;top:365px; left: 390px;
...
<%
String prev=request.getParameter("last");
...
try
{
    ...
    Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
       ...
       ResultSet rs=st.executeQuery("select * from sched where val>"+pre+" ");%>
       <div class="S1"></div>
...
<table border="1" class="table_txt" style="width: 610px; border-collapse: collapse; border-color: #cfcfcf">
 ...
 out.println("</table>");
out.println("&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;");
out.println("<br><br><br><input type='submit' value='   Prev   '>");
out.println("</form>");
